...
Repository: https://github.com/RanaPriyansh/thielon-agent-deploy.git
Canonical local path: /root/git-repos/agent-deploy
Default branch: main
...
3. Run the local setup path for agent-deploy and write exact commands back into README if they are missing or stale.
